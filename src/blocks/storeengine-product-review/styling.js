...
export const getHeaddingCSS = ( attributes, device = '' ) => {
	const typographyValue = parseArgs( attributes?.heading_typography, {
		weight: '400',
	} );

	const typographyGlobal = attributes?.heading_typographyGlobal
...
export const getAvarageCSS = ( attributes, device = '' ) => {
	const typographyValue = parseArgs( attributes?.avg_typography, {
		weight: '400',
	} );

	const typographyGlobal = attributes?.avg_typographyGlobal
...
export const getReviewTextCSS = ( attributes, device = '' ) => {
	...
	const typographyGlobal = attributes?.total_typographyGlobal
...
export const getRatingTextCSS = ( attributes, device = '' ) => {
	const typographyValue = parseArgs( attributes?.listTypography, {
		weight: '400',
	} );

	const typographyGlobal = attributes?.listTypographyGlobal
...
export const getFeedbackStarCSS = ( attributes, device = '' ) => {
	return {
...
export const getRatingFillCSS = ( attributes, device = '' ) => {
