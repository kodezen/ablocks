...
import { getCheckoutButtonWrapperCSS, getCheckoutButtonCSS } from './styling';
import './editor.scss';
...
export default function Edit( props ) {
	...
	const generatedCSS = useMemo( () => {
		...
		cssGenerator.addClassStyles(
			...
			getCheckoutButtonWrapperCSS( attributes ),
			getCheckoutButtonWrapperCSS( attributes, 'Tablet' ),
			getCheckoutButtonWrapperCSS( attributes, 'Mobile' )
		);
		cssGenerator.addClassStyles(
			'{{WRAPPER}} .storeengine-proceed-to-checkout-shortcode a',
			getCheckoutButtonCSS( attributes ),
			getCheckoutButtonCSS( attributes, 'Tablet' ),
			getCheckoutButtonCSS( attributes, 'Mobile' )
		);
