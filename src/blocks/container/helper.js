	...
	switch ( shape ) {
		case 'mountains':
			return (
				...
				>
					<path
						className="ablocks-container-shape-fill"
						opacity="0.33"
...
export const ShapeContainer = ( { position, shape } ) => {
	if ( ! shape ) {
		return null;
	}
	...
	return (
		<div
			className={ `ablocks-container-shape ablocks-container-shape-${ position }` }
		>
			{ getShapeSVG( shape ) }
		</div>
	);
...
export const shapeOptions = [
	...
	{ label: 'Tilt Opacity', value: 'tilt-opacity' },
	{ label: 'Fan Opacity', value: 'fan-opacity' },
	{ label: 'Curve', value: 'curve' },
	{ label: 'Curve Asymmetrical', value: 'curve-asymmetrical' },
	{ label: 'Waves', value: 'waves' },
	{ label: 'Waves Brush', value: 'waves-brush' },
