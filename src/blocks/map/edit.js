...
import { getMapSizeCSS } from './styling';
...
export default function Edit( props ) {
	...
	const generatedCSS = useMemo( () => {
		...
		cssGenerator.addClassStyles(
			'{{WRAPPER}} .ablocks-block-map-base-editor',
			getMapSizeCSS( attributes ),
			getMapSizeCSS( attributes, 'Tablet' ),
			getMapSizeCSS( attributes, 'Mobile' )
		);
