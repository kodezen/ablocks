...
export default function Edit( props ) {
	...
	const generatedCSS = useMemo( () => {
		...
		cssGenerator.addClassStyles(
			...
			getInputLabelHoverCss( attributes ),
			getInputLabelHoverCss( attributes, 'Tablet' ),
			getInputLabelHoverCss( attributes, 'Mobile' )
		);
		...
		let editorInlineCSSExtend = applyFilters(
			`ablocks.academy-student-registration-form.editorInlineCSS`,
			null,
			attributes,
			cssGenerator
		);
