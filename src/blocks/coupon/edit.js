...
export default function Edit( props ) {
	...
	const generatedCSS = useMemo( () => {
		...
		cssGenerator.addClassStyles(
			...
			getCouponTextCSS( attributes ),
			getCouponTextCSS( attributes, 'Tablet' ),
			getCouponTextCSS( attributes, 'Mobile' )
		);

		cssGenerator.addClassStyles(
			'{{WRAPPER}} .ablocks-coupon-code:hover',
			getCouponTextHoverCSS( attributes ),
			getCouponTextHoverCSS( attributes, 'Tablet' ),
			getCouponTextHoverCSS( attributes, 'Mobile' )
		);

		cssGenerator.addClassStyles(
			'{{WRAPPER}} .ablocks-coupon-clipboard',
			getBtnTextCSS( attributes ),
			getBtnTextCSS( attributes, 'Tablet' ),
			getBtnTextCSS( attributes, 'Mobile' )
		);

		cssGenerator.addClassStyles(
			'{{WRAPPER}} .ablocks-coupon-clipboard:hover',
			getBtnTextHoverCSS( attributes ),
			getBtnTextHoverCSS( attributes, 'Tablet' ),
			getBtnTextHoverCSS( attributes, 'Mobile' )
		);
