...
import { updateImageAttributes } from './utils';
import {
	imageLinkOptions,
	imageObjectFit,
	aspectRatioOptions,
...
export default function Settings( props ) {
	const { attributes, setAttributes, isSelected, currentImageData, context } =
		props;
	const {
		imgId,
		imgIdTablet,
	...
	const stylePanel = (
		<>
			...
			<ABlocksBorderControl
				...
				setAttributes={ setAttributes }
			/>
			<ABlocksControlNote note="Border hover worked only frontend" />
			...
			<ABlocksBoxShadowControl
				...
				setAttributes={ setAttributes }
			/>
			<ABlocksControlNote note="Box shadow hover worked only frontend" />
		</>
	);
		...
		<React.Fragment>
			<InspectorControls>
				...
				>
					...
					<ABlocksPanelBody
						title={ __( 'Featured Image', 'ablocks' ) }
						initialOpen={ true }
					>
						<ContentStyleTabs
