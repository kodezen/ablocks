		...
		<React.Fragment>
			<InspectorControls>
				...
				>
						...
						<ContentStyleTabs
							content={
								<>
									...
									/>
									<ABlocksTextControl
										label="Student Register Url"
										attributeValue={ student_register_url }
										setAttributes={ setAttributes }
										attributeName="student_register_url"
									/>
									<ABlocksTextControl
					...
					<ABlocksPanelBody
						title={ __( 'Form Footer Style', 'ablocks' ) }
						initialOpen={ false }
					>
						<ABlocksTypography
							label={ __( 'Typography', 'ablocks' ) }
