...
export const getInputFieldPlaceholderCss = ( attributes ) => {
	return { color: getTextColorCSS( attributes?.inputFieldColor ) };
};
...
export const getLoginFormButtonCss = ( attributes, device = '' ) => {
	...
	const typographyValueGlobal = attributes.login_btn_typographyGlobal
		...
		: '';
	const css = {
		color: getTextColorCSS( attributes?.login_btn_color ),
		background: getTextColorCSS( attributes?.login_btn_bg_color ),
...
export const formTitleHoverCss = ( attributes ) => {
	return {
