...
export default function Edit( props ) {
	...
	const generatedCSS = useMemo( () => {
		...
		cssGenerator.addClassStyles(
			...
			getButtonTextHoverCSS( attributes ),
			getButtonTextHoverCSS( attributes, 'Tablet' ),
			getButtonTextHoverCSS( attributes, 'Mobile' )
		);
		// Icon Style
		cssGenerator.addClassStyles(
		...
		let editorInlineCSSExtend = applyFilters(
			`ablocks.scroll-to-top.editorInlineCSS`,
			null,
			attributes,
			cssGenerator
		);
