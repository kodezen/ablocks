...
import { getCountinueButtonWrapperCSS, getContinueButtonCSS } from './styling';
import './editor.scss';
...
export default function Edit( props ) {
	...
	const generatedCSS = useMemo( () => {
		...
		cssGenerator.addClassStyles(
			...
			getCountinueButtonWrapperCSS( attributes ),
			getCountinueButtonWrapperCSS( attributes, 'Tablet' ),
			getCountinueButtonWrapperCSS( attributes, 'Mobile' )
		);
		cssGenerator.addClassStyles(
			'{{WRAPPER}} .storeengine-continue-shopping-shortcode a',
			getContinueButtonCSS( attributes ),
			getContinueButtonCSS( attributes, 'Tablet' ),
			getContinueButtonCSS( attributes, 'Mobile' )
		);
