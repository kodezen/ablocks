...
export const passwordShowHideIconSize = getRangeAttributes( {
...
const attributes = {
	...
	...iconPickerAttributes( 'passwordShow', {
	...
	...iconPickerAttributes( 'passwordHide', {
	...
	...buttonGroupAttributes( 'passwordType', false, {
		value: 'password',
	} ),
	...globalAttributes,
};
