/******/ (() => { // webpackBootstrap
/*!******************************************!*\
  !*** ./src/blocks/social-shares/view.js ***!
  \******************************************/
document.addEventListener('DOMContentLoaded', function () {
  const socialShareBlocks = document.querySelectorAll('.ablocks-social-share-item');

  // Iterate through each block instance
  socialShareBlocks.forEach(block => {
    // Access `data-windowspopup` from the block itself
    const windowsPopUp = block.getAttribute('data-windowspopup') === 'true';
