/******/ (() => { // webpackBootstrap
/*!***********************************!*\
  !*** ./src/blocks/notice/view.js ***!
  \***********************************/
document.addEventListener('DOMContentLoaded', function () {
  const iconButtons = document.querySelectorAll('.ablocks-block--notice .ablocks-icon-wrap');
  iconButtons.forEach(function (iconButton, index) {
    ...
    if (noticeClose === 'permanent' && storedState === 'hidden' && noticeDiv) {
